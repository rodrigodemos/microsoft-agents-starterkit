...
"""
Generic Agent Host Server — hosts any agent implementing AgentInterface.
Provides M365/Teams-compatible aiohttp server with message routing,
notification handling, observability, and authentication.
"""
...
def create_and_run_host(agent_class: type[AgentInterface], *agent_args, **agent_kwargs):
    ...
    configure(
        service_name=os.getenv("OBSERVABILITY_SERVICE_NAME", "agents-starterkit"),
        service_namespace=os.getenv("OBSERVABILITY_SERVICE_NAMESPACE", "agents-starterkit"),
    )
